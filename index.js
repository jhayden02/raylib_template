...
var ASM_CONSTS = {
  89933: () => { if (document.fullscreenElement) return 1; },  
 89979: () => { return Module.canvas.width; },  
 90011: () => { return parseInt(Module.canvas.style.width); },  
 90059: () => { document.exitFullscreen(); },  
 90086: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 90158: () => { if (document.fullscreenElement) return 1; },  
 90204: () => { return Module.canvas.width; },  
 90236: () => { return screen.width; },  
 90261: () => { document.exitFullscreen(); },  
 90288: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 90421: () => { return window.innerWidth; },  
 90447: () => { return window.innerHeight; },  
 90474: () => { if (document.fullscreenElement) return 1; },  
 90520: () => { return Module.canvas.width; },  
 90552: () => { return parseInt(Module.canvas.style.width); },  
 90600: () => { if (document.fullscreenElement) return 1; },  
 90646: () => { return Module.canvas.width; },  
 90678: () => { return screen.width; },  
 90703: () => { return window.innerWidth; },  
 90729: () => { return window.innerHeight; },  
 90756: () => { if (document.fullscreenElement) return 1; },  
 90802: () => { return Module.canvas.width; },  
 90834: () => { return screen.width; },  
 90859: () => { document.exitFullscreen(); },  
 ...
 91039: ($0) => { Module.canvas.style.opacity = $0; },  
 91077: () => { return screen.width; },  
 91102: () => { return screen.height; },  
 91128: () => { return window.screenX; },  
 91155: () => { return window.screenY; },  
 91182: () => { return window.devicePixelRatio; },  
 91218: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91271: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91322: () => { Module.canvas.style.cursor = 'none'; },  
 91359: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91615: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91666: () => { if (document.pointerLockElement) return 1; },  
 91713: () => { if (document.fullscreenElement) return 1; },  
 91759: () => { return window.innerWidth; },  
 91785: () => { return window.innerHeight; }
};
